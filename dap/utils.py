...
def load_prior_ranges(n_params=11):
    ...
    prior_min = np.array((0.003274, 0.0001, 0.021962, 0.001925, 0.000041, 1.662074,
                          -31.186329, 3.384709 ,4.124004 ,9.287113 ,6.848391))
    prior_max = np.array((0.027263, 0.002, 0.261845, 0.004325, 0.000065, 25.651677,
                         -7.194925, 27.320601, 28.028747, 33.284546, 30.840173))
